                    ...
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            <li class="header__menu--items style2">
                                <a class="header__menu--link" href="home">Inicio</a>
                                <!--
                            ...
                            <li class="header__menu--items style2">
                                ...
                                <ul class="header__sub--menu">
                                    <li class="header__sub--menu__items"><a href="user" class="header__sub--menu__link">Usuarios</a></li>
                                    <li class="header__sub--menu__items"><a href="ofertas" class="header__sub--menu__link">Ofertas</a></li>
                                </ul>
                            </li>
                            <?php } ?>
