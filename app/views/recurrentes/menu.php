            ...
            <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                <div class="header__shipping">
                    <ul class="header__shipping--wrapper d-flex">
                        <li class="header__shipping--text text-white">Welcome to Oferta&mas PTY</li>
        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="#"><img class="main__logo--img" src="assets/img/logo/nav-log.png" alt="logo-img"></a></h1>
                </div>
                ...
                <div class="header__account header__sticky--none">
                    <ul class="d-flex">
                        <?php if(!isset($_SESSION['id_user_oym'])){ ?>
                        <li class="header__account--items">
                            <a class="header__account--btn" href="register">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 512 512"><title>Registro</title><path d="M256 256a112 112 0 1 0 112 112 112 112 0 0 0-112-112zm0 192a80 80 0 1 1 80-80 80 80 0 0 1-80 80z"/><path d="M432 48h-80V0h-16v48h-64V0h-16v48H80a64 64 0 0 0-64 64v352a64 64 0 0 0 64 64h352a64 64 0 0 0 64-64V112a64 64 0 0 0-64-64zm16 416a16 16 0 0 1-16 16H80a16 16 0 0 1-16-16V192h384z"/></svg>
                                <span class="header__account--btn__text">Registro</span>
                            </a>
                        </li>
                        <li class="header__account--items">
                        ...
                        <?php }else{ ?>
                        <li class="header__account--items">
                            <a class="header__account--btn" href="logout">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 512 512"><title>Salir</title><path d="M368 48h-11.41a8 8 0 0 1-7.44-5.08A42.18 42.18 0 0 0 309.87 16H202.13a42.18 42.18 0 0 0-39.28 26.92 8 8 0 0 1-7.44 5.08H144a64 64 0 0 0-64 64v320a64 64 0 0 0 64 64h224a64 64 0 0 0 64-64V112a64 64 0 0 0-64-64zM256 304a16 16 0 1 1 16-16 16 16 0 0 1-16 16zm80-160H176a16 16 0 0 1 0-32h160a16 16 0 0 1 0 32z"/></svg>
                                <span class="header__account--btn__text">Salir</span>
                            </a>
                        </li>
                        <?php } ?>
                    ...
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                                ...
                                <ul class="header__mega--menu d-flex">
                                    ...
                                    <li class="header__mega--menu__li">
                                        ...
                                        <ul class="header__mega--sub__menu">
                                            ...
                                            <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="#">Variable Product</a></li>
                            ...
                            <li class="header__menu--items style2">
                                ...
                                <ul class="header__sub--menu">
                                    <li class="header__sub--menu__items"><a href="#" class="header__sub--menu__link">Blog Grid</a></li>
                                    <li class="header__sub--menu__items"><a href="#" class="header__sub--menu__link">Blog Details</a></li>
                                    <li class="header__sub--menu__items"><a href="#" class="header__sub--menu__link">Blog Left Sidebar</a></li>
                                    <li class="header__sub--menu__items"><a href="#" class="header__sub--menu__link">Blog Right Sidebar</a></li>
                                </ul>
                            </li>
                            ...
                            <?php if(isset($_SESSION['id_user_oym'])){ ?>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link" href="#">Admin 
                                    <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                        <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                    </svg>
                                </a>
                                <ul class="header__sub--menu">
                                    <li class="header__sub--menu__items"><a href="#" class="header__sub--menu__link">Usuarios</a></li>
                                    <li class="header__sub--menu__items"><a href="#" class="header__sub--menu__link">Ofertas</a></li>
                                </ul>
                            </li>
                            <?php } ?>
                ...
                <ul class="offcanvas__menu_ul">
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Home One</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Home Two</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Home Three</a></li>
                        </ul>
                    </li>
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            <li class="offcanvas__sub_menu_li">
                                ...
                                <ul class="offcanvas__sub_menu">
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Shop Left Sidebar</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Shop Right Sidebar</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Shop Grid</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Shop Grid List</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Shop List</a></li>
                                </ul>
                            </li>
                            <li class="offcanvas__sub_menu_li">
                                <a href="#" class="offcanvas__sub_menu_item">Column Two</a>
                                <ul class="offcanvas__sub_menu">
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Product Details</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Video Product</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Variable Product</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Product Left Sidebar</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Product Gallery</a></li>
                                </ul>
                            </li>
                            <li class="offcanvas__sub_menu_li">
                                ...
                                <ul class="offcanvas__sub_menu">
                                    ...
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">My Account 2</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">404 Page</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="login.html">Login Page</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Faq Page</a></li>
                                </ul>
                            </li>
                            <li class="offcanvas__sub_menu_li">
                                <a href="#" class="offcanvas__sub_menu_item">Column Three</a>
                                <ul class="offcanvas__sub_menu">
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Compare Pages</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Checkout page</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Checkout Style 2</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Checkout Style 3</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Checkout Style 4</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Blog Grid</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Blog Details</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Blog Left Sidebar</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Blog Right Sidebar</a></li>
                        </ul>
                    </li>
                    <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="#">Pages</a>
                        <ul class="offcanvas__sub_menu">
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">About Us</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="contact.html" class="offcanvas__sub_menu_item">Contact Us</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Cart Page</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Portfolio Page</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Wishlist Page</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="login.html" class="offcanvas__sub_menu_item">Login Page</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Error Page</a></li>
                        </ul>
                    </li>
