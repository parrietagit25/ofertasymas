                            ...
                            <div class="col">
                                <div class="account__login register">
                                    <div class="account__login--header mb-25">
                                        <h2 class="account__login--header__title h3 mb-10">Crea una cuenta</h2>
                                        <p class="account__login--header__desc">Registrate si eres usuario nuevo</p>
                                    </div>
                                    <div class="account__login--inner">
                                        <input class="account__login--input" placeholder="Nombre completo" type="text" name="nombre">
                                        <input class="account__login--input" placeholder="Email" type="text" name="email">
                                        <input class="account__login--input" placeholder="Password" type="password" name="pass">
                                        <input class="account__login--input" placeholder="Confirmar Password" type="password">
                                        <button class="account__login--btn primary__btn mb-10" type="submit">Registrate</button>
