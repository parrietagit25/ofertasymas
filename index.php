					...
					<div class="row align-items-center">
						<div class="col-lg-7">
							<ul class="header_contact_info ul_li clearfix">
								<li><i class="fal fa-envelope"></i> info@ofertaymas.com</li>
								<li><i class="fal fa-phone"></i> +507-000-00-00000</li>
							</ul>
						</div>
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-6">
							<div class="brand_logo">
								<a href="#">
									<img src="assets/images/logo/logo_01_1x.png" width="200" srcset="assets/images/logo/logo_01_1x.png 2x" alt="logo_not_found">
									<img src="assets/images/logo/logo_01_1x.png" width="200" srcset="assets/images/logo/logo_01_1x.png 2x" alt="logo_not_found">
								</a>
							</div>
						</div>
							...
							<ul class="header_action_btns ul_li_right clearfix">
								...
								<li class="dropdown">
									...
									<div class="cart_dropdown rotors_dropdown dropdown-menu" aria-labelledby="cart_dropdown">
										<h4 class="wrap_title">Carrito de compras: (3)</h4>
										...
										<ul class="btns_group ul_li_block clearfix">
											<li><a href="#" class="custom_btn bg_default_red text-uppercase">Ver carrito <img src="assets/images/icons/icon_01.png" alt="icon_not_found"></a></li>
									...
									<div class="user_dropdown rotors_dropdown dropdown-menu clearfix" aria-labelledby="user_dropdown">
										<div class="profile_info clearfix">
											...
											<div class="user_content">
												<h4 class="user_name"><a href="#!">James Suderlan</a></h4>
												<span class="user_title">Vender</span>
											</div>
										</div>
										<ul class="ul_li_block clearfix">
											<li><a href="#!"><i class="fal fa-user-circle"></i> Perfil</a></li>
											<li><a href="#!"><i class="fal fa-user-cog"></i> Ajustes</a></li>
											<li><a href="#!"><i class="fal fa-sign-out"></i> Salir</a></li>
										</ul>
									</div>
								</li>
								<li>
						...
						<div class="col-lg-6 col-md-12">
							<nav class="main_menu clearfix">
								<ul class="ul_li_center clearfix">
									...
									<li><a href="#">Nuetsras Ofertas</a></li>
			...
			<div id="collapse_search_body" class="collapse_search_body collapse">
				<div class="search_body">
					<div class="container">
						<form action="#">
							<div class="form_item">
								<input type="search" name="search" placeholder="Escribe Aqui...">
			...
			<div class="sidebar-menu-wrapper">
				<div class="mobile_sidebar_menu">
					...
					<div class="menu_list mb_60 clearfix">
						...
						<ul class="ul_li_block clearfix">
							<li class="active dropdown">
								<a href="#!" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Inicio</a>
					...
					<div class="booking_car_form">
						<h3 class="title_text text-white mb-2">Ofertas & Mas</h3>
						<p class="mb_15">
							Encuentra tu oferta ideal
						</p>
						<form action="#">
							<div class="form_item">
								<h4 class="input_title text-white">Localidad</h4>
								<div class="position-relative">
									<input id="location_one" type="text" name="location" placeholder="Ingrese su localidad">
									<label for="location_one" class="input_icon"><i class="fas fa-map-marker-alt"></i></label>
								</div>
							</div>
							<div class="form_item">
								<h4 class="input_title text-white">Fecha</h4>
							...
							<div class="row justify-content-center">
								<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
									<div class="slider_content text-center">
										<h3 class="text-white text-uppercase" data-animation="fadeInUp" data-delay=".3s">Microondas 0.7P3</h3>
										<p data-animation="fadeInUp" data-delay=".5s">
                                            Un microondas compacto y eficiente disponible a un precio especial de $25.00.
										</p>
										<div class="abtn_wrap clearfix" data-animation="fadeInUp" data-delay=".7s">
											<a class="custom_btn bg_default_red btn_width text-uppercase" href="#!">Comprar Ahora <img src="assets/images/icons/icon_01.png" alt="icon_not_found"></a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="item has_overlay d-flex align-items-center" data-bg-image="assets/images/backgrounds/bg_02.jpg">
						...
						<div class="container">
							...
							<div class="row justify-content-center">
								<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
									<div class="slider_content text-center">
										<h3 class="text-white text-uppercase" data-animation="fadeInUp" data-delay=".3s">Barbacoa a Carbón 14" Westinghouse</h3>
										<p data-animation="fadeInUp" data-delay=".5s">
                                        Una barbacoa a carbón portátil de la marca Westinghouse, ideal para asados, por solo $39.95
										</p>
										<div class="abtn_wrap clearfix" data-animation="fadeInUp" data-delay=".7s">
											<a class="custom_btn bg_default_red btn_width text-uppercase" href="#!">Comprar Ahora <img src="assets/images/icons/icon_01.png" alt="icon_not_found"></a>
										</div>
					...
					<div class="item has_overlay d-flex align-items-center" data-bg-image="assets/images/backgrounds/bg_02.jpg">
						...
						<div class="container">
							...
							<div class="row justify-content-center">
								<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
									<div class="slider_content text-center">
										<h3 class="text-white text-uppercase" data-animation="fadeInUp" data-delay=".3s">Freidora Sin Aceite Premier 3.8Lts</h3>
										<p data-animation="fadeInUp" data-delay=".5s">
                                        Una freidora moderna y saludable, que permite cocinar sin aceite, a un precio de oferta de $29.99.
										</p>
										<div class="abtn_wrap clearfix" data-animation="fadeInUp" data-delay=".7s">
											<a class="custom_btn bg_default_red btn_width text-uppercase" href="#!">Comprar Ahora <img src="assets/images/icons/icon_01.png" alt="icon_not_found"></a>
										</div>
						...
						<form action="#">
							<div class="row align-items-end">
								<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
									<div class="form_item">
										<h4 class="input_title text-white">Ubicacion</h4>
										<div class="position-relative">
								...
								<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
									<div class="price-range-area clearfix">
										<h4 class="input_title text-white">Rango de precio</h4>
			...
			<section class="feature_section sec_ptb_150 clearfix">
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
							<div class="section_title mb_60 text-center" data-aos="fade-up" data-aos-delay="100">
								...
								<p class="mb-0">
									Estas son las ofertas mas resaltantes de la semana
								</p>
							</div>
						</div>
					</div>
					...
					<ul class="button-group filters-button-group ul_li_center mb_30 clearfix" data-aos="fade-up" data-aos-delay="300">
						...
						<li><button class="button" data-filter=".viajes">Viajes</button></li>
						<li><button class="button" data-filter=".productos">Productos</button></li>
						<li><button class="button" data-filter=".servicios">Servicios</button></li>
					</ul>

					<div class="feature_vehicle_filter element-grid clearfix">
						<div class="element-item viajes " data-category="viajes">
							<div class="feature_vehicle_item" data-aos="fade-up" data-aos-delay="100">
								...
								<div class="item_image position-relative">
									<a class="image_wrap" href="#!">
										<img width="345" height="260" src="assets/images/feature/img_01.jpg" alt="image_not_found">
									</a>
									<span class="item_price bg_default_blue">$100/Dia</span>
								</div>
						...
						<div class="element-item productos " data-category="productos">
							<div class="feature_vehicle_item" data-aos="fade-up" data-aos-delay="300">
								...
								<div class="item_image position-relative">
									...
									<span class="item_price bg_default_blue">$20</span>
								</div>
								<ul class="info_list ul_li_center clearfix">
									<li>productos</li>
									<li>Joyeria</li>
						...
						<div class="element-item servicios " data-category="servicios">
							<div class="feature_vehicle_item" data-aos="fade-up" data-aos-delay="500">
								...
								<div class="item_image position-relative">
									...
									<span class="item_price bg_default_blue">$30</span>
								</div>
								<ul class="info_list ul_li_center clearfix">
									<li>productos</li>
									<li>Spa</li>
						...
						<div class="element-item viajes " data-category="viajes">
							<div class="feature_vehicle_item" data-aos="fade-up" data-aos-delay="100">
								...
								<div class="item_image position-relative">
									...
									<span class="item_price bg_default_blue">$150/Dia</span>
								</div>
								<ul class="info_list ul_li_center clearfix">
									<li>Ult</li>
									<li>Vuelos</li>
						...
						<div class="element-item servicios " data-category="servicios">
							<div class="feature_vehicle_item" data-aos="fade-up" data-aos-delay="500">
								...
								<div class="item_image position-relative">
									...
									<span class="item_price bg_default_blue">$10</span>
								</div>
								<ul class="info_list ul_li_center clearfix">
									<li>Clean</li>
									<li>Aseo</li>
					...
					<div class="abtn_wrap text-center clearfix" data-aos="fade-up" data-aos-delay="100">
						<a class="custom_btn bg_default_red btn_width text-uppercase" href="#!">Todas las ofertas <img src="assets/images/icons/icon_01.png" alt="icon_not_found"></a>
					</div>
				...
				<div class="container">
					...
					<div class="row justify-content-center">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="service_primary text-center text-white" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <h3 class="item_title text-white">Ofertas Exclusivas Diarias</h3>
                                <p class="mb-0">
                                    Descubre cada día nuevas ofertas exclusivas en una amplia gama de productos.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="service_primary text-center text-white" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <h3 class="item_title text-white">Entrega Rápida y Segura</h3>
                                <p class="mb-0">
                                    Garantizamos una entrega rápida y segura en toda la región.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="service_primary text-center text-white" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <h3 class="item_title text-white">Satisfacción del Cliente</h3>
                                <p class="mb-0">
                                    Nos comprometemos a ofrecer la mejor experiencia de compra.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="service_primary text-center text-white" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <h3 class="item_title text-white">Descuentos Inigualables</h3>
                                <p class="mb-0">
                                    Aprovecha descuentos únicos en una amplia selección de productos y servicios.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="service_primary text-center text-white" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <h3 class="item_title text-white">Alcance Regional</h3>
                                <p class="mb-0">
                                    Ofertas disponibles en toda la región de Centroamérica y Sudamérica.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="service_primary text-center text-white" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <h3 class="item_title text-white">Garantía de Calidad</h3>
                                <p class="mb-0">
                                    Todos nuestros productos son seleccionados para asegurar la más alta calidad.
                                </p>
                            </div>
                        </div>
					...
					<div class="feature_carousel_wrap position-relative clearfix">
						<div class="slideshow1_slider" data-aos="fade-up" data-aos-delay="100">
							<div class="item">
								<div class="feature_fullimage">
									...
									<div class="item_content text-white">
										<span class="item_price bg_default_blue">$100</span>
										<h3 class="item_title text-white">Ofertas Academicas  </h3>
										<a class="text_btn text-uppercase" href="#!"><span>Comprar Oferta</span> <img src="assets/images/icons/icon_02.png" alt="icon_not_found"></a>
									</div>
								</div>
							</div>
							...
							<div class="item">
								<div class="feature_fullimage">
									<img src="assets/images/feature/img_077.jpg" alt="image_not_found">
									<div class="item_content text-white">
										<span class="item_price bg_default_blue">$6</span>
										<h3 class="item_title text-white">Ofertas en ropa  </h3>
										<a class="text_btn text-uppercase" href="#!"><span>Comprar Oferta</span> <img src="assets/images/icons/icon_02.png" alt="icon_not_found"></a>
									</div>
								</div>
							</div>
							...
							<div class="item">
								<div class="feature_fullimage">
									<img src="assets/images/feature/img_0777.jpg" alt="image_not_found">
									<div class="item_content text-white">
										<span class="item_price bg_default_blue">$6</span>
										<h3 class="item_title text-white">Ofertas en todo  </h3>
										<a class="text_btn text-uppercase" href="#!"><span>Ver ofertas</span> <img src="assets/images/icons/icon_02.png" alt="icon_not_found"></a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="row justify-content-lg-between justify-content-center">
						...
						<div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
							<div class="blog_wrap">
								<h3 class="wrap_title mb-0" data-aos="fade-up" data-aos-delay="100">Informacion</h3>
								<div class="row">
										...
										<div class="blog_child" data-aos="fade-up" data-aos-delay="300">
											...
											<div class="item_content">
												<h4 class="item_title mb-0">
													<a href="#">
														Unete a nosotros y trabajemos juntos
													</a>
												</h4>
											</div>
										</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="blog_child" data-aos="fade-up" data-aos-delay="500">
											...
											<div class="item_content">
												<h4 class="item_title mb-0">
													<a href="#">
														Ingrementa tus ventas y clienets
													</a>
												</h4>
											</div>
										</div>
						...
						<div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
							<div class="newsletter_form1">
								<h3 class="form_title mb_30" data-aos="fade-up" data-aos-delay="100">Subscribete:</h3>
								<p class="mb_30" data-aos="fade-up" data-aos-delay="300">
									Unete a nuestro boletin informativo, y enterate a nuestras ofertas
								</p>
								...
								<div class="row" data-aos="fade-up" data-aos-delay="700">
									...
									<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
										<button type="submit" class="custom_btn bg_default_red text-uppercase w-100 d-block">Enviar <img src="assets/images/icons/icon_01.png" alt="icon_not_found"></button>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="testimonial_carousel" data-slick='{"dots": false}' data-aos="fade-up" data-aos-delay="300">
							<div class="item">
								<div class="testimonial_item2 text-center">
									<p class="mb_30">
										“¡Estoy encantada con las ofertas de esta página! Cada compra ha sido una experiencia positiva, con productos de gran calidad y precios que no puedo encontrar en otro lugar. ¡Definitivamente seguiré siendo cliente!”
									</p>
									<div class="admin_info">
										<div class="admin_image">
											<img src="assets/images/meta/img_01.png" alt="image_not_found">
										</div>
										<h4 class="admin_name">Walter Sulliban</h4>
							...
							<div class="item">
								<div class="testimonial_item2 text-center">
									<p class="mb_30">
										“Esta página es un hallazgo increíble. Siempre encuentro lo que necesito a precios sorprendentes, y el servicio al cliente es excepcional. ¡Recomiendo esta tienda a todos mis amigos y familiares!”
									</p>
									<div class="admin_info">
										<div class="admin_image">
											<img src="assets/images/meta/img_01.png" alt="image_not_found">
										</div>
										<h4 class="admin_name">Herry thonson</h4>
										<ul class="rating_star ul_li_center clearfix">
											<li class="active"><i class="fas fa-star"></i></li>
											<li class="active"><i class="fas fa-star"></i></li>
											<li class="active"><i class="fas fa-star"></i></li>
							...
							<div class="item">
								<div class="testimonial_item2 text-center">
									<p class="mb_30">
										“Como cliente habitual, siempre me impresiona la variedad y las ofertas que esta página ofrece. Las entregas siempre son puntuales y los productos superan mis expectativas. ¡Estoy muy satisfecho con cada compra que he realizado!”
									</p>
									<div class="admin_info">
										<div class="admin_image">
											<img src="assets/images/meta/img_01.png" alt="image_not_found">
										</div>
										<h4 class="admin_name">Aeling Galving</h4>
										<ul class="rating_star ul_li_center clearfix">
											<li class="active"><i class="fas fa-star"></i></li>
											<li class="active"><i class="fas fa-star"></i></li>
											<li class="active"><i class="fas fa-star"></i></li>
					...
					<div class="row justify-content-lg-between">
						<div class="col-lg-4 col-md-4 col-sm-12 col-sm-12">
							<div class="footer_about" data-aos="fade-up" data-aos-delay="100">
								<div class="brand_logo mb_30">
									<a href="#">
										<img src="assets/images/logo/logo_01_1x.png" srcset="assets/images/logo/logo_01_1x.png 2x" alt="logo_not_found">
									</a>
								</div>
								<p class="mb_15">
                                    En nuestra página de ventas de ofertas, encontrarás una diversidad de productos a precios increíbles.
								</p>
								<div class="footer_useful_links mb_30">
									<ul class="ul_li_block clearfix">
										<li><a href="#!"><i class="fal fa-angle-right"></i> Informacion General</a></li>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 col-sm-12">
							<div class="footer_contact_info" data-aos="fade-up" data-aos-delay="200">
								...
								<ul class="ul_li_block clearfix">
									<li>
										<strong><i class="fas fa-map-marker-alt"></i> Direccion de la oficina:</strong>
										<p class="mb-0">
											Panama - Costa del este
										</p>
									</li>
									<li><i class="fas fa-clock"></i> 8:00am-9:30pm</li>
									<li><i class="far fa-angle-right"></i> Otras Oficinas</li>
									<li><i class="fas fa-envelope"></i> <strong>info@ofertaymas.com</strong></li>
									<li><i class="fas fa-phone"></i> <strong>+507 000-00-000</strong></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-sm-12">
							<div class="footer_useful_links" data-aos="fade-up" data-aos-delay="300">
								...
								<ul class="ul_li_block clearfix">
									<li><a href="#!"><i class="fal fa-angle-right"></i> Encuentra la oferta mas cercana</a></li>
									<li><a href="#!"><i class="fal fa-angle-right"></i> Ofertas</a></li>
									<li><a href="#!"><i class="fal fa-angle-right"></i> F.A.Q.</a></li>
									<li><a href="#!"><i class="fal fa-angle-right"></i> Sobre nosotros</a></li>
									<li><a href="#!"><i class="fal fa-angle-right"></i> Contactanos</a></li>
									<li><a href="#!"><i class="fal fa-angle-right"></i> Call center</a></li>
									<li><a href="#!"><i class="fal fa-angle-right"></i> Politicas de pribacidad</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container">
					<div class="row align-items-center justify-content-lg-between">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<p class="copyright_text mb-0">Copyright © 2024. Oferta & <a class="author_links text-white" href="#!">Mas</a></p>
						</div>
